...
export function PodcastComposition({ sourcePath, assets = [], clips, captions, sfx, subtitleStyle, items, tracks, timebase, originalAudioVolume = 1, previewAudioPath }: PodcastProps): JSX.Element {
